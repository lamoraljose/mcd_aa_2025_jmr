...
\begin{keyword}
Churn \sep Clasificación binaria \sep Regresión Logística \sep Banca \sep Aprendizaje supervisado
\end{keyword}
...
% (Opcional) Agradecimientos a docentes, mentores o instituciones de apoyo.

\bibliographystyle{elsarticle-num}
% \begin{thebibliography}{00}
% \bibitem{ref1} Breve referencia si la necesitas.
% \end{thebibliography}
